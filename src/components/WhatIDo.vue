...
<div class="grid grid-cols-3 gap-3">
  ...
  >
    ...
    <div class="p-6 flex-1">
      ...
      <p class="text-gray-300 text-xl leading-relaxed">{{ item.description }}</p>
    </div>

    <!-- Image Bottom -->
    <div class="w-full">
      <img :src="item.image" alt="" class="w-full h-48 object-cover rounded-b-2xl" />
    </div>
  </div>
</div>
...
.do-card:hover {
  ...
  border-color: #3ccf91; /* Subtle green border on hover */
}
</style>
