<template>
  <div :class="isOpen ? 'bg-opacity-50' : ''" class="relative">
    <nav class="lg:bg-transparent lg:mt-0 lg:rounded-none lg:backdrop-filter-none fixed top-0 left-0 right-0 mx-4 z-50">
      ...
      <div class="flex items-center justify-between p-4 bg-gray-800 rounded-full mt-4 bg-opacity-90 backdrop-blur-lg text-gray-100 lg:max-w-7xl lg:mx-auto lg:mt-6 shadow-md">
        <!-- Logo -->
        ...
        <ul class="hidden lg:flex items-center space-x-10">
          ...
          <li>
            <button
              ...
              class="px-6 py-2 bg-gradient-to-r from-[#00ffcc] to-blue-500 rounded-full
